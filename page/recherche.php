...
<script type="text/javascript">
            ...
            function myFunction() {
                ...
                var trajet = '<div class="container shadow-lg p-3 mb-5 bg-white rounded " id="container2" style=" margin-top: 30px; width: 50%;" > <div class="row"> <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1" > <div class="short-div trajet-place" id="depart-time-trajet">10:00</div> <div class="short-div trajet-vertical-separator"></div> <div class="short-div trajet-place" id="arrivee-time-trajet" style="margin-top: -10px;">16:45</div> </div> <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"> <div class="short-div "> <span class="dot trajet-circle" style="vertical-align: bottom;"></span> </div> <div class="short-div vertical-line trajet-vertical-separator"></div> <div class="short-div"> <span class="dot trajet-circle" ></span> </div> </div> <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1"> <div class="short-div trajet-place" id="depart-trajet">Paris</div> <div class="short-div trajet-vertical-separator" ></div> <div class="short-div trajet-place" id="arrivee-trajet" style="margin-top: -10px;">Lyon</div> </div> <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" ></div> <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 trajet-place" id="prix-trajet">54,00 $</div> </div> <div class="row" style="margin-top: 30px;"> <div class="col-lg-2 col-md-1 col-sm-1 col-xs-1" > <img src="img/img-profile.jpg" id="img-profile" alt="img-profile"> </div> <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2"> <div class="short-div" id="trajet-nom-prenom"> <span id="trajet-name">Ismail</span> </div> <div class="short-div " style="height: 30px;"></div> <div class="short-div" id="trajet-rating"> <img src="img/star.png" id="trajet-star" alt="img-star" height="30" width="30"> <strong id="rating-text" >5</strong> </div> </div> </div> </div>';
